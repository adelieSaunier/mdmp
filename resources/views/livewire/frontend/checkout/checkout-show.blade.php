        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        ...
                        <hr>
                        <small>* Les produits seront livrés en 3 à 8 jours ouvrés</small>
                        <br/>
                        <small>* Les taxes et la livraison sont comprises</small>
                    </div>
                </div>
                    ...
                    <div class="shadow bg-white p-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" wire:model.defer="fullname" id="fullname" class="form-control" placeholder="Entrez votre prénom et nom" />
                                @error('fullname') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Numéro de téléphone</label>
                                <input type="number" wire:model.defer="phone" id="phone" class="form-control" placeholder="Entrez votre numéro de portable" />
                                @error('phone') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Adresse mail</label>
                                <input type="email" wire:model.defer="email" id="email" class="form-control" placeholder="Entrez votre mail" />
                                @error('email') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Code postal</label>
                                <input type="number" wire:model.defer="pincode" id="pincode" class="form-control" placeholder="Entrez votre code postal" />
            ...
            @else
                <div class="card card-body shadow text-center p-md-5">
                    <h4>Pas de produit dans votre panier</h4>
                    <a href="{{ url('categories') }}" class="btn btn-warning">Voir nos produits</a>
                </div>
            @endif
...
@push('scripts')
    <script src="https://www.paypal.com/sdk/js?client-id=AcymiMcgTD8Uc1UudjpCfrbjPd9LyQus_01Klg8AkWmsQiq1MtZy_n89jPECDnOtWWtPOUypXDX2VyZj&currency=EUR"></script>
    <script>
        paypal.Buttons({
            onClick: function()  {
            ...
            onApprove: (data, actions) => {
                return actions.order.capture().then(function(orderData) {
                    ...
                    console.log('Résultat capturé :', orderData, JSON.stringify(orderData, null, 2));
