        ...
        <div class="container">
                            ...
                            <div class="cart-item">
                                <div class="row">
                                    <div class="col-md-6 my-auto">
                                        <a href="{{ url('produit/'.$cartItem->product->category->slug.'/'.$cartItem->product->slug) }}">
                                            <label class="product-name">
                                                ...
                                                @if ($cartItem->productColor)
                                                    ...
                                                    <span> Couleur : {{ $cartItem->productColor->color->name }}</span>
                                                    @endif
                                                @endif
                                            </label>
                                        </a>
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h5>
                        <a href="{{ url('/categories') }}">Continuer mon shopping</a>
                    </h5>
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        ...
                        <hr>
                        <a href="{{ url('/checkout') }}" class="btn btn-warning w-100">Régler</a>
                    </div>
                </div>
            </div>
