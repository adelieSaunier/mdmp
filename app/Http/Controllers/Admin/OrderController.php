...
class OrderController extends Controller
{
    ...
    public function show(int $orderId)
    {
        ...
        if($order){
            ...
            return redirect('admin/orders')->with('message','la commande n\'est pas trouvée');
        }
    }
    ...
    public function mailInvoice(int $orderId)
    {
        try{
            ...
            return redirect('admin/orders/'.$orderId)->with('message','La facture a été envoyé à '.$order->email);
